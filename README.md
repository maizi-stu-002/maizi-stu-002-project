...
* 为便于代码管理，大家需要在`dev`分支下面建立各自的分支，需要提交到远程库时合并到`dev`分支再提交。
...
####2015-08-15更新
* `models.py`和`admin.py`初步完成,为避免冲突过多，不建议大家直接修改这两个文件，若确认要修改，可告知组长或副组长，由组长或副组长统一修改。
* `base.html`模板修改完成，置于`templates`根目录。
