...
class UserProfile(AbstractUser):
    avatar_url = models.CharField(u'头像地址', upload_to='avatar/%Y/%m', default='avatar/default.png',
                                  max_length=200, blank=True)
    avatar_thumbnail_url = models.CharField(u'头像缩略图地址', upload_to='avatar_thumbnail/%Y/%m',
...
class Certificate(models.Model):
    ...
    image_url = models.CharField(u'证书图片地址', upload_to='certificate/%Y/%m', max_length=200, blank=True)
...
class BadgeDict(models.Model):
    ...
    badge_url = models.CharField(u'徽章地址', upload_to='badge/%Y/%m', max_length=200, blank=True)
...
class Teacher(models.Model):
    ...
    position = models.CharField(max_length=64, verbose_name=u'职位')
    description = models.CharField(max_length=256, verbose_name=u'描述')
...
class MyCourse(models.Model):
    ...
    course_type = models.CharField(u'课程类型', choice=course_type, max_length=1)
...
class Blog(models.Model):
    ...
    comment = models.ManyToManyField(BlogComment, null=True, blank=True, verbose_name=u'评论')
    category = models.ManyToManyField(BlogCategoryDict, null=True, blank=True, verbose_name=u'分类')
...
class Keywords(models.Model):
    ...
    blog = models.ManyToManyField(Blog, verbose_name=u'博客', null=True, blank=True)
...
class UserPurchase(models.Model):
    ...
    pay_price = models.DecimalField(u'购买价格')
    ...
    pay_way = models.CharField(u'支付方式', choices=pay_way, blank=True)
    pay_status = models.CharField(u'支付状态', choices=pay_status, blank=True)
...
class CareerCourse(models.Model):
    ...
    total_price = models.DecimalField(u'总共价格')
...
class Ad(models.Model):
    ...
    img_utl = models.CharField(u'图片链接', upload_to='ad/%Y/%m', max_length=200)
...
class Log(models.Model):
    ...
    action_type = models.CharField(u'类型', choice=action_type, max_length=1, blank=True)
